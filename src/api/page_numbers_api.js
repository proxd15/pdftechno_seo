 ...
 * @param {FormData} formData - FormData containing PDF file and options
 * @param {Function} onProgress - Progress callback (0-100)
 * @returns {Promise} - Promise that resolves with result
 */
export const addPageNumbers = async (formData, onProgress) => {
  try {
    ...
    return new Promise((resolve, reject) => {
      ...
      xhr.open('POST', `${API_BASE_URL}/api/pdf/add-page-numbers/`, true);
